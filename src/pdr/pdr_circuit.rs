// use crate::utils::{generalize::{generalize_by_ternary_simulation_tmp}, state_transform::aig_cube_next};
...
//             let predecessor = generalize_by_ternary_simulation_tmp(&self.aig, cex, &assumption);
...
//                 let cex = generalize_by_ternary_simulation_tmp(&self.aig, cex, &[self.aig.bads[0]]);
