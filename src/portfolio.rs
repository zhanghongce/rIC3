...
impl Portfolio {
    pub fn new(option: Options) -> Self {
        ...
        new_engine("-e ic3 --ic3-no-dynamic --rseed 55");
        new_engine("-e ic3 --ic3-no-dynamic --ic3-ctp --rseed 5555");
        new_engine("-e ic3 --ic3-no-dynamic --ic3-ctg");
        new_engine("-e ic3 --ic3-no-dynamic --ic3-ctg --ic3-ctg-limit 5");
        new_engine("-e ic3 --ic3-no-dynamic --ic3-ctg --ic3-ctg-max 5 --ic3-ctg-limit 15");
        new_engine("-e ic3 --ic3-no-dynamic --ic3-ctg --ic3-abs-cst --rseed 55");
        new_engine("-e ic3 --ic3-no-dynamic --ic3-ctg --ic3-ctp");
        new_engine("-e ic3 --ic3-no-dynamic --ic3-ctg --ic3-inn");
        new_engine("-e ic3 --ic3-no-dynamic --ic3-ctg --ic3-ctg-limit 5 --ic3-inn");
